...
public class RateLimitFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest req, HttpServletResponse res, FilterChain chain)
        ...
        if (sw.exceeded()) {
            TooManyRequestsResponse.write(req, res, limit, resetEpochSec, "rate limit exceeded");
            return;
        }
        chain.doFilter(req, res);
    }
    ...
    private boolean enforceAuthTier(HttpServletRequest req, HttpServletResponse res,
        ...
        if (sw.exceeded()) {
            TooManyRequestsResponse.write(req, res, authEndpointPerMinute, resetEpochSec,
