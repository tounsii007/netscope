...
/**
 * Classifies a resolved {@link InetAddress} as safe-to-scan or blocked.
 * Owns the full SSRF block list: RFC-reserved ranges, cloud metadata
 * endpoints, IPv6 ULA + IPv4-compatible IPv6 forms, carrier-grade NAT,
 * and the "future-use" /4. Pure logic, no Spring.
 *
 * Kept in sync with {@code ip/IpAddressGuard.isBlocked()} and
 * {@code web/lib/target-guard.ts} — all three must agree on categories.
 */
final class BlockedAddressRules {
